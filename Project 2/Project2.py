# -*- coding: utf-8 -*-
"""
Created on Sun Nov  4 11:50:40 2018
@author: Aniket Gade
"""

import os, copy, random, math
from sklearn.metrics import confusion_matrix
#path = "C:/Users/Aniket Gade/Desktop/20_newsgroups/"
path = os.getcwd()
path = path + "/20_newsgroups/"
...
def clean_text(data):
    ...
    """
    data = data.replace('\n', ' ')  #remove new lines
    replace_l = ["'",'!','/','\\','=',',',':', '<','>','?','.','"',')','(','|','-','#','*','+', '_']      #list of characters to remoe
...
#-----------------------------------------------------------------------------------------------------
def create_bag(training_split, file_name):
...
if __name__ == "__main__":
    training_split = 500
    file_name ={}
    folder_list, dictionary = create_bag(training_split, file_name) 
